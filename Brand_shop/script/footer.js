...
let footerUpInner = `
        ...
        <div class="footerUp__right">
            <div class="footerUp__menu"> <span class="footerUp__header">COMPANY</span> <a href="index.html" class="footerUp__point">Home</a> <a href="index.html" class="footerUp__point">Shop</a> <a href="#" class="footerUp__point">About</a> <a href="#" class="footerUp__point">How It Works</a> <a href="#" class="footerUp__point">Contact</a> </div>
            ...
            <div class="footerUp__menu"> <span class="footerUp__header">SHOP CATEGORY</span> <a href="product.html" class="footerUp__point">Men</a> <a href="product.html" class="footerUp__point">Women</a> <a href="#" class="footerUp__point">Child</a> <a href="#" class="footerUp__point">Apparel</a> <a href="#" class="footerUp__point">Browse All</a> </div>
        </div>
`;
